package com.zlw.main.linkwifidemo.utils.blankj;
...
import com.zlw.main.linkwifidemo.MyApp;
...
//        MyApp.getInstance().startActivity(IntentUtils.getDialIntent(phoneNumber));
//    }
//
//    /**
//     * 拨打电话
...
//        MyApp.getInstance().startActivity(IntentUtils.getCallIntent(phoneNumber));
//    }
//
//    /**
//     * 跳至发送短信界面
...
//        MyApp.getInstance().startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content));
//    }
//
//    /**
//     * 发送短信
...
//        PendingIntent sentIntent = PendingIntent.getBroadcast(MyApp.getInstance(), 0, new Intent(), 0);
