...
public class WifiActivity extends AppCompatActivity {
        ...
        wifiLinkDialogBuilder.setPositiveButton("远程连接", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (wifiLinkDialogViewHolder != null) {
                    ...
                    WifiConnectActivity.startMe(WifiActivity.this, jsonStr);
    ...
    private void init() {
        WifiActivityPermissionsDispatcher.selectWifiWithCheck(this);
        WifiActivityPermissionsDispatcher.startScanWithCheck(this);
    ...
    public void startScan() {
        Intent intent = new Intent(WifiActivity.this, CaptureActivity.class);
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            if (null != data) {
                ...
                if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
                    ...
                    Toast.makeText(WifiActivity.this, "解析二维码失败", Toast.LENGTH_LONG).show();
